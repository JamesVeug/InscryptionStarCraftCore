...
namespace StarCraftCore.Scripts.Data
{
    public static class DataUtil
    {
        ...
        public static T LoadFromFile<T>(string path, string pluginDirectory) where T : AData
        {
            string fullPath = Path.Combine(pluginDirectory, path);
            //Plugin.Log.LogInfo("Loading file at path '" + fullPath + ".");
